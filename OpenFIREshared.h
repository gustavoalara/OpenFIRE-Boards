...
public:
    ...
    const std::unordered_map<std::string_view, int> settingsTypes_Strings = {
        ...
        {"TriggerOffEffect",     btnTriggerOffEffect},
        {"TriggerOffColor",      btnTriggerOffColor},
    
        {"Pump ActionOnEffect",         btnPumpOnEffect},
        {"Pump ActionOnColor",          btnPumpOnColor},
        {"Pump ActionOffEffect",        btnPumpOffEffect},
        {"Pump ActionOffColor",         btnPumpOffColor},

        {"PedalOnEffect",      btnPedalOnEffect},
        {"PedalOnColor",       btnPedalOnColor},
        {"PedalOffEffect",     btnPedalOffEffect},
        {"PedalOffColor",      btnPedalOffColor},

        {"Alt PedalOnEffect",      btnPedal2OnEffect},
        {"Alt PedalOnColor",       btnPedal2OnColor},
        {"Alt PedalOffEffect",     btnPedal2OffEffect},
        {"Alt PedalOffColor",      btnPedal2OffColor},
    
        {"Button AOnEffect",         btnGunAOnEffect},
        {"Button AOnColor",          btnGunAOnColor},
        {"Button AOffEffect",        btnGunAOffEffect},
        {"Button AOffColor",         btnGunAOffColor},
    
        {"Button BOnEffect",         btnGunBOnEffect},
        {"Button BOnColor",          btnGunBOnColor},
        {"Button BOffEffect",        btnGunBOffEffect},
        {"Button BOffColor",         btnGunBOffColor},
    
        {"Button COnEffect",         btnGunCOnEffect},
        {"Button COnColor",          btnGunCOnColor},
        {"Button COffEffect",        btnGunCOffEffect},
        {"Button COffColor",         btnGunCOffColor},
    
        {"StartOnEffect",         btnStartOnEffect},
        {"StartOnColor",          btnStartOnColor},
        {"StartOffEffect",        btnStartOffEffect},
        {"StartOffColor",         btnStartOffColor},
    
        {"SelectOnEffect",         btnSelectOnEffect},
