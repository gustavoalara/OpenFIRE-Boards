...
public:
    ...
    enum {
        ...
        // Trigger
        btnTrigger_OnScreen_neoPixelEffect,
        btnTrigger_OnScreen_neoPixelEffectColor,
        btnTrigger_OffScreen_neoPixelEffect,
        btnTrigger_OffScreen_neoPixelEffectColor,
        
        // Pump
        btnPump_OnScreen_neoPixelEffect,
        btnPump_OnScreen_neoPixelEffectColor,
        btnPump_OffScreen_neoPixelEffect,
        btnPump_OffScreen_neoPixelEffectColor,

        // Pedal
        btnPedal_OnScreen_neoPixelEffect,
        btnPedal_OnScreen_neoPixelEffectColor,
        btnPedal_OffScreen_neoPixelEffect,
        btnPedal_OffScreen_neoPixelEffectColor,

        // AltPedal
        btnPedal2_OnScreen_neoPixelEffect,
        btnPedal2_OnScreen_neoPixelEffectColor,
        btnPedal2_OffScreen_neoPixelEffect,
        btnPedal2_OffScreen_neoPixelEffectColor,

        // A button
        btnGunA_OnScreen_neoPixelEffect,
        btnGunA_OnScreen_neoPixelEffectColor,
        btnGunA_OffScreen_neoPixelEffect,
        btnGunA_OffScreen_neoPixelEffectColor,

        // B button
        btnGunB_OnScreen_neoPixelEffect,
        btnGunB_OnScreen_neoPixelEffectColor,
        btnGunB_OffScreen_neoPixelEffect,
        btnGunB_OffScreen_neoPixelEffectColor,

        // C button
        btnGunC_OnScreen_neoPixelEffect,
        btnGunC_OnScreen_neoPixelEffectColor,
        btnGunC_OffScreen_neoPixelEffect,
        btnGunC_OffScreen_neoPixelEffectColor,

        // Start
        btnStart_OnScreen_neoPixelEffect,
        btnStart_OnScreen_neoPixelEffectColor,
        btnStart_OffScreen_neoPixelEffect,
        btnStart_OffScreen_neoPixelEffectColor,

        // Select
        btnSelect_OnScreen_neoPixelEffect,
        btnSelect_OnScreen_neoPixelEffectColor,
        btnSelect_OffScreen_neoPixelEffect,
        btnSelect_OffScreen_neoPixelEffectColor,
    ...
    const std::unordered_map<std::string_view, int> settingsTypes_Strings = {
        ...
        {"Trigger_OnScreen_NeoPixelEffect",      btnTrigger_OnScreen_neoPixelEffect},
        {"Trigger_OnScreen_NeoPixelEffectColor", btnTrigger_OnScreen_neoPixelEffectColor},
        {"Trigger_OffScreen_NeoPixelEffect",     btnTrigger_OffScreen_neoPixelEffect},
        {"Trigger_OffScreen_NeoPixelEffectColor",btnTrigger_OffScreen_neoPixelEffectColor},
    
        {"Pump Action_OnScreen_NeoPixelEffect",         btnPump_OnScreen_neoPixelEffect},
        {"Pump Action_OnScreen_NeoPixelEffectColor",    btnPump_OnScreen_neoPixelEffectColor},
        {"Pump Action_OffScreen_NeoPixelEffect",        btnPump_OffScreen_neoPixelEffect},
        {"Pump Action_OffScreen_NeoPixelEffectColor",   btnPump_OffScreen_neoPixelEffectColor},

        {"Pedal_OnScreen_NeoPixelEffect",      btnPedal_OnScreen_neoPixelEffect},
        {"Pedal_OnScreen_NeoPixelEffectColor", btnPedal_OnScreen_neoPixelEffectColor},
        {"Pedal_OffScreen_NeoPixelEffect",     btnPedal_OffScreen_neoPixelEffect},
        {"Pedal_OffScreen_NeoPixelEffectColor",btnPedal_OffScreen_neoPixelEffectColor},

        {"Alt Pedal_OnScreen_NeoPixelEffect",      btnPedal2_OnScreen_neoPixelEffect},
        {"Alt Pedal_OnScreen_NeoPixelEffectColor", btnPedal2_OnScreen_neoPixelEffectColor},
        {"Alt Pedal_OffScreen_NeoPixelEffect",     btnPedal2_OffScreen_neoPixelEffect},
        {"Alt Pedal_OffScreen_NeoPixelEffectColor",btnPedal2_OffScreen_neoPixelEffectColor},
    
        {"Button A_OnScreen_NeoPixelEffect",         btnGunA_OnScreen_neoPixelEffect},
        {"Button A_OnScreen_NeoPixelEffectColor",    btnGunA_OnScreen_neoPixelEffectColor},
        {"Button A_OffScreen_NeoPixelEffect",        btnGunA_OffScreen_neoPixelEffect},
        {"Button A_OffScreen_NeoPixelEffectColor",   btnGunA_OffScreen_neoPixelEffectColor},
    
        {"Button B_OnScreen_NeoPixelEffect",         btnGunB_OnScreen_neoPixelEffect},
        {"Button B_OnScreen_NeoPixelEffectColor",    btnGunB_OnScreen_neoPixelEffectColor},
        {"Button B_OffScreen_NeoPixelEffect",        btnGunB_OffScreen_neoPixelEffect},
        {"Button B_OffScreen_NeoPixelEffectColor",   btnGunB_OffScreen_neoPixelEffectColor},
    
        {"Button C_OnScreen_NeoPixelEffect",         btnGunC_OnScreen_neoPixelEffect},
        {"Button C_OnScreen_NeoPixelEffectColor",    btnGunC_OnScreen_neoPixelEffectColor},
        {"Button C_OffScreen_NeoPixelEffect",        btnGunC_OffScreen_neoPixelEffect},
        {"Button C_OffScreen_NeoPixelEffectColor",   btnGunC_OffScreen_neoPixelEffectColor},
    
        {"Start_OnScreen_NeoPixelEffect",         btnStart_OnScreen_neoPixelEffect},
        {"Start_OnScreen_NeoPixelEffectColor",    btnStart_OnScreen_neoPixelEffectColor},
        {"Start_OffScreen_NeoPixelEffect",        btnStart_OffScreen_neoPixelEffect},
        {"Start_OffScreen_NeoPixelEffectColor",   btnStart_OffScreen_neoPixelEffectColor},
    
        {"Select_OnScreen_NeoPixelEffect",         btnSelect_OnScreen_neoPixelEffect},
        {"Select_OnScreen_NeoPixelEffectColor",    btnSelect_OnScreen_neoPixelEffectColor},
        {"Select_OffScreen_NeoPixelEffect",        btnSelect_OffScreen_neoPixelEffect},
        {"Select_OffScreen_NeoPixelEffectColor",   btnSelect_OffScreen_neoPixelEffectColor},
    };
